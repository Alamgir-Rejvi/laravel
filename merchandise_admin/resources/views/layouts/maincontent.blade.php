    ...
    <div class="pc-content">
      ...
      <div class="row">
        ...
        <div class="col-md-6 col-xl-3">
          <div class="card">
            <div class="card-body">
              <h6 class="mb-2 f-w-400 text-muted">Total Buyers</h6>
              <h4 class="mb-3">4,42 <span class="badge bg-light-primary border border-primary"><i
        ...
        <div class="col-md-6 col-xl-3">
          <div class="card">
            <div class="card-body">
              <h6 class="mb-2 f-w-400 text-muted">Total Pending Sample</h6>
        ...
        <div class="col-md-6 col-xl-3">
          <div class="card">
            <div class="card-body">
              <h6 class="mb-2 f-w-400 text-muted">Total Payment Received</h6>
